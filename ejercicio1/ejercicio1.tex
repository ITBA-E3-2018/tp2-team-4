...
Se implementaron dos compuertas NOT con tecnología BJT: una variante con un transistor NPN () y otra con un transistor PNP (). Sus diseños se pueden observar en la siguiente figura.

%insertar referencias a figuras de diseño
...
\end{table}
\end{center}
Posteriormente, midiendo las curvas de entrada y salida en simult\'aneo, se obtuvieron los tiempos de transici\'on y las demoras de propagaci\'on para ambas compuertas. Luego, se cargaron las compuertas con un capacitor de 10nF, y obteniendo la derivada de la tensión de salida, utilizando la ley de Ohm para capacitores pudo determinarse la corriente m\'axima a trav\'es de la compuerta. Estos datos figuran en la siguiente tabla.
\begin{center}
\begin{table}[H]
\begin{tabular}{|l|l|l|}
\hline
...
\textbf{Propagation Delay Low to High} & 3.22 µs      & 101 ns       \\ \hline
...
\begin{figure}[H]% este es para caption arriba o abajo
  \centering
    ...
    \caption{Medici\'on máxima derivada de tensión en la salida NPN} %caption abajo
\end{figure}

\begin{figure}[H]% este es para caption arriba o abajo
  \centering
    \includegraphics[width=0.4\textwidth]{maxI-PNP}
    \caption{Medici\'on máxima derivada de tensión en la salida PNP} %caption abajo
\end{figure}
\end{center}
\end{multicols}
\iffalse
