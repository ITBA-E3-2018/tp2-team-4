...
Si se quisiera cargar una compuerta LS con una HC no habr\'ia problema, pues el m\'aximo voltaje de output para nivel bajo de una LS es menor que el m\'aximo que una HC interpreta como bajo y el m\'inimo de salida para nivel alto de una LS es mayor que el m\'inimo para que HC lo considere alto. 
